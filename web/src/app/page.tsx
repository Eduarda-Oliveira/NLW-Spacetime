...
import nlwLlogo from '../assets/nlw-spacetime-logo.svg'
  ...
  return (
    <main className="grid min-h-screen grid-cols-2">
      ...
      <div className=" relative flex flex-col items-start justify-between overflow-hidden bg-[url(../assets/bg-stars.svg)] bg-cover px-28 py-16">
        {/* Blur */}
        <div className="absolute right-0 top-1/2 h-[288px] w-[526px] -translate-y-1/2 translate-x-1/2 rounded-full border-white/10 bg-purple-700 opacity-50  blur-full" />
        ...
        <div className="space-y-5">
          <Image src={nlwLlogo} alt="NLW Spacetime" />
